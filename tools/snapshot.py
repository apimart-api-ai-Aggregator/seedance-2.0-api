#!/usr/bin/env python3
"""Refresh Seedance 2.0 (seedance-2.0) pricing from the public pricing payload.
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Refresh Seedance 2.0 pricing")
    ...
    payload = {"id": PRIMARY, "alias": "seedance-2.0-fast / seedance-2.0-mini / seedance-2.0-face", "official": OFFICIAL,
