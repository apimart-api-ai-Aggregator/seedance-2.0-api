#!/usr/bin/env bash
# Seedance 2.0 (seedance-2.0) video generation: submit, poll, print cost. Set APIMART_API_KEY first.
set -euo pipefail
...
{"model":"seedance-2.0","prompt":"$PROMPT","size":"$SIZE","resolution":"$RESOLUTION","duration":$DURATION,"generate_audio":false}
JSON
